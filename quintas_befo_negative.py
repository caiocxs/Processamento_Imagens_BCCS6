        ...
        if image_atual:
            ...
            for column in range(0, height):
                for row in range(0, width):
                    ...
                    new_img[row,column] = (r,g,b)
            
            show_image()
    except Exception as e:
        sg.popup(f"Erro ao inverter as cores: {str(e)}")

def sepia_img_colors():
    global image_anterior
    global image_atual
    try:
        filter_r = 150
        ...
        if image_atual:
            ...
            for column in range(0, height):
                for row in range(0, width):
                    ...
                    r = r + filter_r if r + filter_r <= 255 else 255
                    g = g + filter_g if g + filter_g <= 255 else 255
                    b = b + filter_b if b + filter_b <= 255 else 255
...
def undo():
    global image_anterior
    global image_atual
    if image_anterior is None:
        return
    image_atual = image_anterior.copy()
